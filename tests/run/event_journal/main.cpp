...
const char* KindName(core::EventKind kind) {
  switch (kind) {
    ...
    case core::EventKind::kSpecialistArrived:
    ...
    case core::EventKind::kElectrificationUnlocked:
    ...
    case core::EventKind::kSocialStatusChanged:
    ...
    case core::EventKind::kPlanTraded:
      return "plan_traded";
    case core::EventKind::kAmbulanceSent:
      return "ambulance_sent";
    case core::EventKind::kAmbulanceAtHouse:
