...
# ══════════════════════════════════════════ 8
h("8. Расхождение с демографической кривой")
print("Демография (demography.md §4): год 11 — 370 жителей, ещё Эпоха I;")
print("год 14 — около 500 и уже Эпоха II.")
print()
for ppl, ga_cap in ((370, ga_po_loshadyam(60)), (500, ga_po_loshadyam(60))):
    print("%d жителей на потолке ступени 2 (%.0f га) — это %.2f га на едока"
          % (ppl, ga_cap, ga_cap / ppl))
print("Норма зрелого хозяйства: %.1f-%.1f га на едока (49-simulations §2)"
      % GA_NA_EDOKA)
print()
print("Либо в Эпохе I норма ниже — ЛПХ кормит село и колхозной пашни на едока")
print("нужно меньше, либо конюшня должна держать %.0f мест к 11-му году,"
      % (loshadey(370 * GA_NA_EDOKA[0]) / ZAPAS + 0.5))
print("и тогда никакого барьера в Эпохе I нет.")
