...
# ─── Канон: карта ───
# ЗАПИСЬ ПРОГОНА, А НЕ ТЕКУЩИЙ КАНОН: карта стала 12 × 12 км 1 сентября 2026,
# а числа ниже посчитаны на 10 × 10 и вместе с ними записаны в 49-simulations.md.
# Поднять константу — значит молча переписать результат прошлого замера; кому
# нужна карта сегодняшнего дня, тот заводит новый прогон.
MAP_KM = 10.0                       # terrain.md §1 на день прогона
