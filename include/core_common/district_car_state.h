...
/// sim thread (core_production/district_car.h, 0.34.18); read by the
/// presentation through the completed world. Whether a resident is away is
/// asked of core_common/away_in_district.h and nowhere else.
///
/// The contract of 954699c (save 79) stood without its implementation from
/// 19 September to 0.34.18, marked STUB then.
///
