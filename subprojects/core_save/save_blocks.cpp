// The scalar world blocks (save_blocks.h; the ledger is save_ledger.cpp). Same law as the
...
// The YearLedger's tripwires and their history left with its codec for
// save_ledger.cpp (0.36.32).
